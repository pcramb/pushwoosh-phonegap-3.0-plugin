 ...
 * the {@link PushServiceHelper#getPushServiceClassName(android.content.Context)} must be overridden.
 */
public class GCMBroadcastReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
	    ...
	    String className = PushServiceHelper.getPushServiceClassName(context);
