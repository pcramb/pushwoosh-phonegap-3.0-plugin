...
public class Helper
{
	...
	{
		//App icon is default. The bad thing it is 48x48, on 1dp device notification icon should be 24x24, and it will be cropped :( 
		int iconId = context.getApplicationInfo().icon;
		
		//If resources defines "pw_notification" resource - this is our icon
		int notificationId = context.getResources().getIdentifier("pw_notification", "drawable", context.getPackageName());
		if (notificationId != 0)
		{
