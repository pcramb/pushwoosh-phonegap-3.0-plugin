...
public class PushEventsTransmitter
{
    ...
    private static void transmit(final Context context, String stringToShow, String messageKey, Bundle pushBundle)
    {
        ...
        //a little bit of reflection magic
        //used for Unity plugin to notify already instantiated app that push has arrived 
        Class<?> clazz;
		try {
			clazz = Class.forName("com.arellomobile.android.push.PushwooshProxy");
			if(clazz != null) {
		        Method method = clazz.getMethod("getInstanceOrNull");
		        Object obj = method.invoke(null, (Object[]) null);
		        if(obj != null) {
			        Method method2 = clazz.getMethod("checkMessage", Intent.class);
			        method2.invoke(obj, notifyIntent);
		        }
			}
        }
		catch (Exception e) {
