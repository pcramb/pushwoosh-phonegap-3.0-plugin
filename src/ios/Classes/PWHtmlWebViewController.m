...
- (NSUInteger)supportedInterfaceOrientations {
    return ((supportedOrientations & PWOrientationPortrait) ? UIInterfaceOrientationMaskPortrait : 0)
    | ((supportedOrientations & PWOrientationPortraitUpsideDown) ? UIInterfaceOrientationMaskPortraitUpsideDown : 0)
    | ((supportedOrientations & PWOrientationLandscapeLeft) ? UIInterfaceOrientationMaskLandscapeLeft : 0)
    | ((supportedOrientations & PWOrientationLandscapeRight) ? UIInterfaceOrientationMaskLandscapeRight : 0);
}
